...
const string strMessageMagic = "Darkcypher Signed Message:\n";
...
int64_t GetProofOfWorkReward(int nHeight, int64_t nFees)
{
    ...
    {
        nSubsidy = 4000000 * COIN; // ICO AMOUNT 
    }
		else if(pindexBest->nHeight < 90000 )
    {
		nSubsidy = 0 * COIN; // Backup Hardcoded Blocks
    }
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Darkcypher", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "Dark cypher";
        CTransaction txNew;
        txNew.nTime = 1444130910;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0xfdcf0f35a828cd22fe6235a4fa8051dfe4eb3b3c2fbb92e5d18e092f40da09b8"));
        block.print();
