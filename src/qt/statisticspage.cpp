...
void StatisticsPage::updateStatistics()
{
    ...
    {
        phase = "DCYP POS + HARDCODED POW BLOCKS ";
    }
    ...
    {
        ui->volumeBox->setText("<b><font color=\"#ebbcff\">" + qVolume + " DCYP" + "</font></b>");
    } else if(volume < volumePrevious) {
        ui->volumeBox->setText("<b><font color=\"red\">" + qVolume + " DCYP" + "</font></b>");
    } else {
        ui->volumeBox->setText(qVolume + " DCYP");
    }
